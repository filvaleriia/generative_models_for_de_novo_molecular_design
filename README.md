...
The archived data package for this repository is available on Zenodo: [10.5281/zenodo.19466540](https://doi.org/10.5281/zenodo.19466540).

Warning: the complete archived data package is large (approximately `34 GB`), so downloading it may take some time and sufficient local storage is required.
